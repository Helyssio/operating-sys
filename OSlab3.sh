...
#Enchanced Server Health Checkup Script
...
check_running_processes(){
    ...
    echo "5. Total of all running processes: "
    ps -e | wc -l
}
...
#Fonction to check memory utilization
check_memory_utilization(){
    ...
    echo "4. Top 5 memory-consumig processes: "
...
#Fonction to check for zombies processes
check_zombie_processes(){
    echo " ------- Cheking Zombie Processes ------ "

    #Killing zombie processes
    echo "1. Killing zombie processes: "
    ps aux |awk '$8=="Z" print {print "kill -9 " $2}' | sh
...
#Fonction to check load average
check_load_average(){
    ...
    #Number of user currently logged in
    echo "5. Number of user currently logged in: "
    uptime | awk '{print $4}'
